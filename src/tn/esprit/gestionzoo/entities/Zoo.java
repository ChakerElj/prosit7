...
import tn.esprit.gestionzoo.exceptions.AnimalException;
import tn.esprit.gestionzoo.exceptions.ZooExceptions;
import tn.esprit.gestionzoo.exceptions.ZooFullException;

public class Zoo {

    public static final int NUMBER_OF_CAGES = 3; // changer pour tester l'exception ZooFullException
    ...
    public void addAnimal(Animal animal) throws ZooExceptions, AnimalException {
        if (animal.getAge() < 0)
            throw new AnimalException("Age is not valid you enter a negative value");
